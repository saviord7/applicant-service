...
arr_field_names = [
    ...
    'НАПРАВЛЕНИЕ_В_ПРИКАЗЕ_БАЛЛ', 'НАПРАВЛЕНИЕ_В_ПРИКАЗЕ_ПРЕДМЕТ_1_ПРИОРИТЕТ',
...
data_row = {
    'УРОВЕНЬ_ДИПЛОМА': 'Среднее',
    'БАЛЛ_ЗА_ДОСТИЖЕНИЯ': '15',
    'ЕСТЬ_АТТЕСТАТ_С_ОТЛИЧИЕМ': 'on',
    'ЕСТЬ_ДИПЛОМ_С_ОТЛИЧИЕМ': 'on',
    'БАЛЛ_ОЛИМПИАДЫ_И_КОНКУРСЫ': '5',
    'ОЦЕНКА_ЗА_СОЧИНЕНИЕ': '5',
    ...
    'НАПРАВЛЕНИЕ_В_ПРИКАЗЕ_ОЦЕНКА_3': '90',
    'НАПРАВЛЕНИЕ_В_ПРИКАЗЕ_БАЛЛ': '280',
